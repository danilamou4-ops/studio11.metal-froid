...
-- ====== SECTION 1: Teams + memberships (RBAC foundation) ======
...
-- ====== SECTION 2: Playlist contribution workflow + quality gate fields ======
...
-- ====== SECTION 3: Governance audit log (approval/rejection/archive/rollback actions) ======
...
-- ====== SECTION 4: Community feedback (upvote/downvote + written reviews) ======
...
-- ====== SECTION 5: Quality tickets (support -> admin escalation) ======
